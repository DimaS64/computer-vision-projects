...
# Pushover settings
PUSHOVER_USER_KEY = "ugv8dxg5z97257oifxvtn5d1r23kt7"
PUSHOVER_APP_TOKEN = "agwjqec4yqn8js6pc9qr965s7h3ams"
...
"/home/pi/latest.jpg")
        ...
        if len(analysis['results']) == 0:
            ...
            if last_seen is not None:
                pushover.Client(PUSHOVER_USER_KEY).send_message(last_seen + " left",title="Driveway")
            ...
            if last_seen is None:
                pushover.Client(PUSHOVER_USER_KEY).send_message(number_plate + " has arrived", title="Driveway")
            elif number_plate != last_seen:
                pushover.Client(PUSHOVER_USER_KEY).send_message(number_plate + " arrived  and " + last_seen + " left",title="Driveway")
